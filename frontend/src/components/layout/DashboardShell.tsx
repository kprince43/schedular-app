...
import {
  ...
  LogOut, Menu, X, Bell, Search, ChevronDown, Repeat2,
} from 'lucide-react';
...
const navItems = [
  ...
  { href: '/dashboard/routines',  icon: Repeat2,         label: 'Routines'  },
    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 shrink-0">
          ...
          <p className="hidden sm:block text-sm font-medium text-slate-600">{activeLabel}</p>
